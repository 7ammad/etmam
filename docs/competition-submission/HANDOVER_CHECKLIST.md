...
## Repository Address and Branch Information

The project repository can be found at https://github.com/7ammad/etmam. Please use the branch named **ASUS-Version** for the latest updates relevant to this handover. For a comprehensive summary, scope details, operating guide, and presentation slides, refer to the **docs/competition-submission/** directory within the repository. If the board requires a specific submission form or template, please use it and attach this repository link along with the branch name for reference.
