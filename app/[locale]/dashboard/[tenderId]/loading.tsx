    ...
    <Container size="4" py="6">
      <Flex direction="column" gap="6">
        ...
        <Box style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
          <Box style={{ height: 28, width: '80%', maxWidth: 480, borderRadius: 'var(--radius-2)', background: 'var(--gray-a3)' }} className="animate-pulse" />
        ...
        {[1, 2, 3].map((i) => (
          <Card key={i} size="2" style={{ background: 'var(--surface-card)' }}>
            ...
            <Flex direction="column" gap="2">
              ...
              <Box style={{ height: 16, width: '70%', borderRadius: 'var(--radius-1)', background: 'var(--gray-a3)' }} className="animate-pulse" />
            </Flex>
          </Card>
        ))}
      </Flex>
